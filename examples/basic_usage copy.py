...
async def main():
    ...
    try:
        ...
        await sdk.execute_action("Type https://aperturedata.io into the url bar")
        ...
        await sdk.execute_action("Click on the 'Login' button")

        time.sleep(3)

        await sdk.execute_action("Click on the 'Continue with Google' button")

        time.sleep(3)


        await sdk.execute_action("Click on the 'peytoncas@gmail.com' account")
